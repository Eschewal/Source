  ...
  const sysapps = [
    {
      ...
      settings: [
        ...
        { id: '@chavy_boxjs_userCfgs.bgimgs', name: '背景图片清单', val: '跟随系统', type: 'text', placeholder: '跟随系统', persistentHint:true, desc: '逗号分隔名字和链接, 回车分隔多个地址' },
        { id: '@chavy_boxjs_userCfgs.bgimg', name: '背景图片', val: '', type: 'text', placeholder: '', persistentHint:true, desc: '输入背景图标的在线链接' },
